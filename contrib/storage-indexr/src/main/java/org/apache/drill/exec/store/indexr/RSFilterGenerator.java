  ...
  public RCOperator visit(SqlCall call) {
    switch (call.getKind()) {
      ...
      case GREATER_THAN: {
        ...
        Greater op = new Greater(av.attr, av.num, av.str);
        return av.switchDirection? op.switchDirection() : op;
      }
      case GREATER_THAN_OR_EQUAL: {
        ...
        GreaterEqual op = new GreaterEqual(av.attr, av.num, av.str);
        return av.switchDirection? op.switchDirection() : op;
      }
      case IN: {
        Attr attr = toAttr(call.operand(0));
        SqlNode vns = call.operand(1);
        if (attr == null || !(vns instanceof SqlNodeList)) {
          return new UnknownOperator(call.toString());
        }
      ...
      case LESS_THAN: {
        ...
        Less op = new Less(av.attr, av.num, av.str);
        return av.switchDirection? op.switchDirection() : op;
      }
      case LESS_THAN_OR_EQUAL: {
        ...
        LessEqual op = new LessEqual(av.attr, av.num, av.str);
        return av.switchDirection? op.switchDirection() : op;
      }
      default:
        return new UnknownOperator(call.toString());
